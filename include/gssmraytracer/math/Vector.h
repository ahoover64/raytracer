...
namespace gssmraytracer {
  ...
  namespace math {
    ...
    public:
      ...
      //! Initialozes a Vector from P1 to P2
      Vector(const geometry::Point p1, const geometry::Point p2);
      ...
      //! Returns whether or not this is the same vector as the passed one
